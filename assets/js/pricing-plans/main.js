...
function first()
{
    document.getElementById('content-c7f83ad64e3ba5bb17d4').style.display = 'block';
    document.getElementById('content-5608c6f64e3ba5bb17d4').style.display = 'none';
    document.getElementById('content-3d90a3564e3ba5bb17d4').style.display = 'none';
    document.getElementById('content-eff0b2764e3ba5bb17d4').style.display = 'none';
    document.getElementById('content-21340cd64e3ba5bb17d4').style.display = 'none';

}
function second()
{
    document.getElementById('content-c7f83ad64e3ba5bb17d4').style.display = 'none';
    document.getElementById('content-5608c6f64e3ba5bb17d4').style.display = 'block';
    document.getElementById('content-3d90a3564e3ba5bb17d4').style.display = 'none';
    document.getElementById('content-eff0b2764e3ba5bb17d4').style.display = 'none';
    document.getElementById('content-21340cd64e3ba5bb17d4').style.display = 'none';
}
function third()
{
    document.getElementById('content-c7f83ad64e3ba5bb17d4').style.display = 'none';
    document.getElementById('content-5608c6f64e3ba5bb17d4').style.display = 'none';
    document.getElementById('content-3d90a3564e3ba5bb17d4').style.display = 'block';
    document.getElementById('content-eff0b2764e3ba5bb17d4').style.display = 'none';
    document.getElementById('content-21340cd64e3ba5bb17d4').style.display = 'none';
}
function fourth()
{
    ...
    document.getElementById('content-5608c6f64e3ba5bb17d4').style.display = 'none';
    document.getElementById('content-3d90a3564e3ba5bb17d4').style.display = 'none';
    document.getElementById('content-eff0b2764e3ba5bb17d4').style.display = 'block';
    document.getElementById('content-21340cd64e3ba5bb17d4').style.display = 'none';
}
function fifth()
{
    ...
    document.getElementById('content-3d90a3564e3ba5bb17d4').style.display = 'none';
    document.getElementById('content-eff0b2764e3ba5bb17d4').style.display = 'none';
    document.getElementById('content-21340cd64e3ba5bb17d4').style.display = 'block';
}
// document.getElementById('myPopup').addEventListener("mouseover", (event) => {
//     console.log('asdfsadf');
//     var popup = document.getElementById("myPopup");
//     popup.classList.toggle("show");
// });
function overpopup(id){
    var popup = document.getElementById(id);
    popup.classList.toggle("show");
}
function outpopup(id){
    var popup = document.getElementById(id);
    popup.classList.toggle("show");
}
