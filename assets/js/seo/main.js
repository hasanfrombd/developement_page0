...
jQuery(document).ready(function () {
    ...
    function initArrows(parentid2) {
        ...
        objRemoteApi.onWidgetInit("uc_arrow_navigation_elementor_c2ac47e", function (objWidget) {
    ...
    var objWidget = jQuery("#uc_arrow_navigation_elementor_c2ac47e");
...
jQuery(document).ready(function () {
    function uc_card_carousel_elementor_89fdd72_start() {

        var objCarousel = jQuery('#uc_card_carousel_elementor_89fdd72');
    ...
    } if (jQuery("#uc_card_carousel_elementor_89fdd72").length) uc_card_carousel_elementor_89fdd72_start();
    jQuery(document).on('elementor/popup/show', (event, id, objPopup) => {
        if (objPopup.$element.has(jQuery("#uc_card_carousel_elementor_89fdd72")).length) uc_card_carousel_elementor_89fdd72_start();
    });
});
...
jQuery(document).ready(function () {
    function uc_card_carousel_elementor_e1445b6_start() {

        var objCarousel = jQuery('#uc_card_carousel_elementor_e1445b6');
    ...
    } if (jQuery("#uc_card_carousel_elementor_e1445b6").length) uc_card_carousel_elementor_e1445b6_start();
    jQuery(document).on('elementor/popup/show', (event, id, objPopup) => {
        if (objPopup.$element.has(jQuery("#uc_card_carousel_elementor_e1445b6")).length) uc_card_carousel_elementor_e1445b6_start();
    });
});
...
jQuery(document).ready(function () {
    function uc_card_carousel_elementor_c04ec4b_start() {

        var objCarousel = jQuery('#uc_card_carousel_elementor_c04ec4b');
    ...
    } if (jQuery("#uc_card_carousel_elementor_c04ec4b").length) uc_card_carousel_elementor_c04ec4b_start();
    jQuery(document).on('elementor/popup/show', (event, id, objPopup) => {
        if (objPopup.$element.has(jQuery("#uc_card_carousel_elementor_c04ec4b")).length) uc_card_carousel_elementor_c04ec4b_start();
    });
});
...
//
jQuery(document).ready(function () {
    function uc_card_carousel_elementor_7cfe86a555_start() {

        var objCarousel = jQuery('#uc_card_carousel_elementor_7cfe86a555');
    ...
    } if (jQuery("#uc_card_carousel_elementor_7cfe86a555").length) uc_card_carousel_elementor_7cfe86a555_start();
    jQuery(document).on('elementor/popup/show', (event, id, objPopup) => {
        if (objPopup.$element.has(jQuery("#uc_card_carousel_elementor_7cfe86a555")).length) uc_card_carousel_elementor_7cfe86a555_start();
    });
});